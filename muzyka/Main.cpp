...
int main() {
    ...
    dinoSprite.setPosition(820, 20); // Ustawienie pozycji dino2, podniesienie o 10 pikseli
    dinoSprite.setScale(1.25f, 1.25f); // Powiększenie grafiki 1.25-krotnie
    ...
    coinSprite.setPosition(820, 80); // Ustawienie pozycji monety
    coinSprite.setScale(4.0f, 4.0f); // Powiększenie grafiki 4-krotnie
    ...
    distanceText.setPosition(window.getSize().x - 280 - distanceText.getGlobalBounds().width, 10); // Przesunięcie tekstu 280 pikseli od prawej krawędzi i obniżenie o 10 pikseli

    sf::Text coinCountText("0", font, 50);
    coinCountText.setFillColor(sf::Color::White); // Ustawienie koloru tekstu na biały
    coinCountText.setPosition(window.getSize().x - 280 - coinCountText.getGlobalBounds().width, 70); // Przesunięcie tekstu 280 pikseli od prawej krawędzi i obniżenie o 5 pikseli
